...
larger GPUs. \hl{Today the largest GPU's in the market contain $\approx$50 SMs (NVIDIA's Pascal contains
...
While most of these applications are unlikely to scale to thousands of GPUs across an 
entire data center without additional developer effort, moderate programmer transparent performance 
scalability will be
be attractive for applications that already contain sufficient algorithmic and data parallelism.}
