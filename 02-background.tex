...
of thread blocks (CTAs) is intentionally limited by the programmer or the problem dataset can not
be easily scaled up (e.g. scaling the dataset requires new algorithmic changes or 
results in above linear increase in memory footprint).
