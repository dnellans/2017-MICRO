...
by using write through caches (to eliminate the need track dirty lines in 
hardware), and without explicit hardware coherence support required at any level 
of the cache hierarchy. Memory-side L2 caches, by definition, do not require 
...
Coherence protocols are not one-size fits all}~\cite{NehasSelectiveGPUcache,saritaGPUscopingwork,kaeliwork}\hl{.  
