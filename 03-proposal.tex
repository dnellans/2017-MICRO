...
them on multiple PCIe attached GPUs in parallel}~\cite{Cabezas2015}\hl{.} For example, on NVIDIA GPUs 
...
\hl{GPU coherence protocols are not one-size fits all}~\cite{sinclair2015efficient,Power2013}\hl{.  
...
\hl{In this work we implement and examine the scalability of one such cache coherence 
