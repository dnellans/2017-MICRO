...
By dynamically reallocating capacity to cache local or remote memory depending
on bandwidth saturation, NUMA-aware GPUs improve performance by XXX\% over 
current GPU caching policies.  Overall, a NUMA-aware GPU is
able to outperform a UMA optimized GPU by XXX\%, XXX\%, and XXX\% in
and achieve XXX\%, XXX\%, and XXX\% of theoretical scalability, 2, 4, and 8 
socket designs respectively.
\end{abstract}