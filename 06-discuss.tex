...
In Sections~\ref{sec:interconnect} and~\ref{caching} we explored the performance 
...
\begin{figure*}[t]
    ...
    \caption{Performance scalability of a NUMA-aware GPU compared to theoretical maximim applications performance moving from 1 to 8 GPU sockets.}
