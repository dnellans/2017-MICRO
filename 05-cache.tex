...
of multiple \hl{processes} within a single GPU~\cite{park2015chimera, lin2016enabling, puthoor2016implementing, kyriazis2012heterogeneous}. If a large NUMA GPU is sub-partitioned, it is intuitive 
...
operations have on application performance in our 4-socket NUMA GPU.  
...
on significant fine grain synchronization between GPUs and CPUs.
Additionally, we evaluated
the effect of using write-through policy in the L2 caches rather than write-back (to mirror
