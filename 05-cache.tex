...
(Step \circled{2}). If the L2 is a write-back cache, dirty lines from the 
...
remote, and allocates it now to a set of local ways (Step \circled{3}). 
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/plot_dynamic_cache_WB.pdf}
